...
@SpringBootApplication(scanBasePackages = "com.Spring.SeuCarro")
@EntityScan("com.Spring.SeuCarro.entity")
// @EnableJpaRepositories("com.Spring.SeuCarro.dao.jpa")
@EnableMongoRepositories("com.Spring.SeuCarro.dao.mongo")
